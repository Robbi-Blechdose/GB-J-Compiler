/**
 * The GB-J Compiler
 * Copyright (C) 2019 Julius Clasen
...
import de.jc.gbjc.main.Lexing.Lexer;
 ...
 * 
 */
//TODO: Redo to contains not number of args, but arg types
//TODO: Rewrite the entire fukin thing
public class PreliminaryParser
{
    private List<Token> tokens;
    private int i;
    
    private List<String> staticMethods; //<return type>|<name>|<list of argument types>
    ...
    (
        //Utils.asm
        "void|readPad",
        "char|isButtonPressed|char",
        "char|wasButtonPressed|char",
        "void|switchSpeed",
        //LCD.asm
        "void|lcdOff",
        "void|loadPalettes|2",
        ...
        "void|clearScreen",
        "void|print|3",
        "void|printNumber|char|char|char",
        //Sprites.asm
        "void|dmaTransfer",
        "void|copyDMARoutine",
        "void|clearOAM",
        "void|setSpritePosition|char|char|char",
        "void|setSpriteTile|char|char",
        "void|setSpriteAttributes|char|char",
        //Tiles.asm
        "void|loadTiles|4",
        "void|setBGTile|4",
        "void|setWinTile|4",
        "void|loadBGMap|6",
        "void|loadWinMap|6",
        "void|setBGScroll|char|char",
        "void|setWinPosition|char|char",
        //GBPrinter.asm
        "char|initPrinter",
        "char|transferData",
        "char|getStatus",
